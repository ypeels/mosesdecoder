...
$cmd = "$MOSES_DIR/contrib/other-builds/tok-align/tok-align $SPLIT_INPUT_STEM.$TARGET $UNSPLIT_INPUT_STEM.esc.$TARGET --method 2 --new-split-path $SPLIT_INPUT_STEM.juncture.$TARGET > temp.align";
safesystem($cmd);
