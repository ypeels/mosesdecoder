...
class NonTermContextTargetProperty : public PhraseProperty
{
public:

  NonTermContextTargetProperty();
  ~NonTermContextTargetProperty();

  virtual void ProcessValue(const std::string &value);

  virtual const std::string *GetValueString() const {
    UTIL_THROW2("NonTermContextTargetProperty: value string not available in this phrase property");
    return NULL;
  };
